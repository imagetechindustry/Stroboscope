    ...
    <footer className="bg-white text-gray-900 font-bold border-t border-gray-200 pt-16 mt-auto">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          {/* Column 3: Our Products (Focused on Stroboscopes) */}
          <div>
            <h4 className="text-gray-900 font-bold mb-4 uppercase tracking-wide border-b-2 border-blue-500 inline-block pb-1">
              OUR PRODUCTS
            </h4>
            <ul className="space-y-3 text-sm text-gray-900 font-bold font-semibold">
              <li>
                ...
                >
                  ...
                  <span>LED Handheld Stroboscope</span>
                </Link>
              </li>
              <li>
                <Link
                ...
                >
                  ...
                  <span>LED Handheld Stroboscope with Lens</span>
                </Link>
              </li>
              <li>
                <Link
                ...
                >
                  ...
                  <span>Xenon Flash Tube Stroboscope</span>
                </Link>
              </li>
              <li>
                <Link
                ...
                >
                  ...
                  <span>U Tube Fixed Model Stroboscope</span>
                </Link>
              </li>
            </ul>
          </div>
