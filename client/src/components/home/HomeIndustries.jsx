        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            <h2 className="text-3xl md:text-4xl font-extrabold text-gray-900 leading-tight mb-6">
              Supporting Diverse Industries with Reliable Solutions{locationData ? ` in ${locationData.name}` : ''}
            </h2>
            <p className="text-lg text-gray-900 mb-10">
              Our stroboscopes are widely used across various industries to
              ensure quality, efficiency and reliability in printing, packaging,
            ...
            <div className="grid grid-cols-3 gap-4 mt-8">
              <div className="text-center">
                ...
                <p className="text-xs text-gray-900">
                  Observe high-speed moving parts clearly.
                </p>
              </div>
              <div className="text-center">
                <div className="w-12 h-12 mx-auto bg-blue-50 text-blue-600 rounded-full flex items-center justify-center mb-3">
              ...
              <div className="text-center">
                ...
                <p className="text-xs text-gray-900">
                  Optimized for high-speed visual inspection.
                </p>
              </div>
            </div>
          </div>
